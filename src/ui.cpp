...
//         );
    ...
    {   
        if(data_number > 0)
        {
            int index_increment = data_number / 25;
            double new_dataset[6][25];
            for(int i = 0; i < 25; i++)
            {
                int raw_index = i * 25;
                new_dataset[0][i] = data_buff[0][raw_index];
                new_dataset[1][i] = data_buff[1][raw_index];
                new_dataset[2][i] = data_buff[2][raw_index];
                new_dataset[3][i] = data_buff[3][raw_index];
                new_dataset[4][i] = data_buff[4][raw_index];
                new_dataset[5][i] = data_buff[5][raw_index];
